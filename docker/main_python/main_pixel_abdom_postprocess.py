...
if __name__ == "__main__":
    ...
    list_output_residual_post_processed = create_residual(caps_test_output_path = args.caps_output, subjects_sessions_file = args.tsv, mode = "pixel", mean_path = args.mean_path, std_path = args.std_path, brain=False)
